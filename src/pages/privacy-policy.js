...
const PrivacyPolicy = () => (
  <Layout>
    <div style={{ margin: '50px 10%' }}>
      <h1>blogwise Privacy Policy</h1>

      <p>Effective date: March 07, 2019</p>

      <p>
        blogwise ("us", "we", or "our") operates the https://www.blogwise.co
        website (the "Service").
      </p>
      ...
      <p>
        ...
        our Terms and Conditions, accessible from https://www.blogwise.co
      </p>
      ...
      <p>blogwise uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        blogwise will take all steps reasonably necessary to ensure that your
      ...
      <p>
        blogwise may disclose your Personal Data in the good faith belief that
        such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of blogwise</li>
        <li>
      ...
      <ul>
        <li>By email: support@blogwise.co</li>
      </ul>
    </div>
  </Layout>
)
